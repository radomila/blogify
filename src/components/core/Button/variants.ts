...
export const buttonVariants = cva('flex items-center justify-center gap-1 cursor-pointer', {
  variants: {
    variant: {
      default: '',
      form: 'text-white bg-primary font-medium',
      detail: 'text-primary font-medium',
      create: 'text-white bg-primary font-medium',
      error: 'text-white bg-error',
      errorSecondary: 'text-error bg-white outline-1 outline-error font-medium',
      upload: 'text-white bg-primary',
      uploadSecondary: 'text-primary bg-white outline-1 outline-primary',
    },
    size: {
      default: '',
