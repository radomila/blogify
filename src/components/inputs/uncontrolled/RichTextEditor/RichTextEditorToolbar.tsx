...
import ToggleItemStyled from '@/components/inputs/uncontrolled/RichTextEditor/ToggleItemStyled';
import UploadImageDialog from '@/components/core/UploadImageDialog';
...
const RichTextEditorToolbar = ({ editor }: Props) => {
  ...
  return (
    <Toolbar.Root
      className="flex w-full min-w-fit rounded-md rounded-br-none rounded-bl-none bg-white p-2.5 border border-b-0 border-shadow"
    ...
    >
      ...
      <Toolbar.Separator className="w-px bg-shadow mx-[10px]" />
      <Toolbar.ToggleGroup
        type="single"
